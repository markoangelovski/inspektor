...
return [
    ...
    'description' => 'REST API for accessing websites, pages, and content extraction data from Inspektor.',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can create a personal access token by visiting <b>Settings → API Tokens</b> in the application.',
    ],
